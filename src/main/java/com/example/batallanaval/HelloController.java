...
public class HelloController {
    ...
    public void creacionBarcos() {
        ...
        control.addBarco(barcoDesEsp = new Barcos("destructor", "Azul", destructorImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoAcoEsp = new Barcos("acorazado", "Azul", acorazadoImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoLanEsp = new Barcos("lancha", "Azul", lanchaImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoSubEsp = new Barcos("submarino", "Azul", submarinoImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoDesFr = new Barcos("destructor", "Rojo", destructorImg2, control.getBarcos(), bola));
        ...
        control.addBarco(barcoAcoFr = new Barcos("acorazado", "Rojo", acorazadoImg2, control.getBarcos(), bola));
        ...
        control.addBarco(barcoLanFr = new Barcos("lancha", "Rojo", lanchaImg2, control.getBarcos(), bola));
        ...
        control.addBarco(barcoSubFr = new Barcos("submarino", "Rojo", submarinoImg2, control.getBarcos(), bola));
